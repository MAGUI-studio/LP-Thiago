        ...
        <div className="relative group/carousel">
          ...
          >
            {courses.map((course, index) => (
              <div
                key={index}
                className="relative snap-start shrink-0 w-[290px] sm:w-[330px] bg-white border border-gray-100 p-8 flex flex-col justify-between h-[210px]  hover:-translate-y-1 transition-all duration-300 rounded-none overflow-hidden group/card"
              >
